...
/**
 * Service zur Kommunikation mit Keycloak (Authentifizierung für das Film-Projekt).
 */
export class KeycloakService {
    ...
    /**
     * Holt ein Access-Token von Keycloak für einen Benutzer.
     */
    ...
    /**
     * Extrahiert Rollen und Metadaten aus dem JWT-Token (nur Debug-Logging).
     */
