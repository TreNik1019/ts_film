...
```shell
    docker history niklastremmel/film:2026.5.24-hardened
    docker history niklastremmel/film:2026.5.24-trixie
    docker history niklastremmel/film:2026.5.24-alpine
```
...
```shell
    docker inspect niklastremmel/film:2026.5.24-hardened
    docker inspect niklastremmel/film:2026.5.24-trixie
    docker inspect niklastremmel/film:2026.5.24-alpine
```
...
```shell
    docker sbom niklastremmel/film:2026.5.24-hardened
    docker sbom niklastremmel/film:2026.5.24-trixie
    docker sbom niklastremmel/film:2026.5.24-alpine
```
...
```shell
    cd extras\compose\film

    # Shell fuer film-Server mit Trixie-Image zzgl. DB-Server und Mailserver
    docker compose up
    ...
    # Shell: film-Server einschl. DB-Server und Mailserver herunterfahren
    cd extras\compose\film
    docker compose down
```
...
```shell
    docker scout quickview niklastremmel/film:2026.5.24-hardened
    docker scout quickview niklastremmel/film:2026.5.24-trixie
    docker scout quickview niklastremmel/film:2026.5.24-alpine
```
...
```shell
    docker scout cves niklastremmel/film:2026.5.24-hardened
    docker scout cves --format only-packages niklastremmel/film:2026.5.24-hardened
```
